...
public class Search {
	...
	//skill
	public Search(Integer mentorId, Integer techId, Integer skillId, String toc, String prerequisites, Double fee) {
	...
	public Search(Integer mentorId, String mentorFirstName, String mentorLastName, Integer yearExp, String linkedInUrl,
			Integer techId, Integer skillId, String toc, String prerequisites, Double fee) {
	...
	//all
	public Search(Integer mentorId, String mentorFirstName, String mentorLastName, Integer yearExp, String linkedInUrl,
			Integer techId, String techName, Integer skillId, String toc, String prerequisites, Double fee,
